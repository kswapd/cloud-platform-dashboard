...
var compile_html = function() {
    ...
    fs.copy('./src/h.html', './public/h.html', handle_error)
    fs.copy('./src/login.html', './public/login.html', handle_error)
    fs.copy('./node_modules/materialize-css/dist/fonts/roboto', './public/fonts/roboto', handle_error);
};
var compile_images = function() {
    fs.copy('./src/images', './public/images', handle_error);
};
